# voicetest Background Research

Background research informing design decisions. Merges the former `RESEARCH.md`
(testing landscape, platform approaches, architecture decisions) and `MOLTBOT.md`
(OpenClaw integration notes). Internal notes, excluded from the published docs site.

______________________________________________________________________

# Testing Landscape & Architecture
